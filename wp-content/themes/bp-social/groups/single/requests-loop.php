		...
		<?php while ( bp_group_membership_requests() ) : bp_group_the_membership_request(); ?>
			...
			<li>
				...
				<div class="action">
					...
					<?php bp_button( array( 'id' => 'group_membership_reject', 'block_self' => false, 'component' => 'groups', 'wrapper_class' => 'reject', 'link_href' => bp_get_group_request_reject_link(), 'link_title' => __( 'Reject', 'buddypress' ), 'link_text' => __( 'Reject', 'buddypress' ) ) ); ?>
