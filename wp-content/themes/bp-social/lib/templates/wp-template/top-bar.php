...
<?php if( $bp ) { //check if bp existed ?>
<li id="li-user"><?php _e('Welcome back', TEMPLATE_DOMAIN); ?>, <a href="<?php echo bp_core_get_user_domain( $user_ID ) ?>"><?php global $bp; echo $bp->loggedin_user->fullname; ?></a></li>
