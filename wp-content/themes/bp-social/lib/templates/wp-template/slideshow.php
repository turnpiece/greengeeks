...
<a href="#"><?php wp_custom_post_thumbnail($the_post_id=$the_post_ids , $with_wrap='', $wrap_w='', $wrap_h='', $title=get_the_title(), $fetch_size='large', $fetch_w='630', $fetch_h='9999',$alt_class='full feat-thumb'); ?></a>
