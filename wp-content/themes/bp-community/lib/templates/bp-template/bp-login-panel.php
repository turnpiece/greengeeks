...
<div id="logout-link">
<?php bp_loggedin_user_avatar( 'width=25&height=25' ) ?><p><a href="<?php bp_loggedinuser_link() ?>"><?php global $bp; echo $bp->loggedin_user->fullname; ?></a> / <a href="<?php echo wp_logout_url( bp_get_root_domain() ) ?>"><?php _e( 'Log Out', TEMPLATE_DOMAIN ) ?></a>
<?php do_action( 'bp_login_bar_logged_in' ) ?></p>
</div>
<?php endif; ?>
