...
<label for="rememberme"><?php _e( 'Remember Me', TEMPLATE_DOMAIN ) ?></label>
...
<?php else : ?>
<div id="logout-link">
<?php bp_loggedin_user_avatar( 'width=50&height=50' ) ?> &nbsp; <?php _e("Welcome back",TEMPLATE_DOMAIN); ?>, <a href="<?php bp_loggedin_user_link() ?>"><?php global $bp; echo $bp->loggedin_user->fullname; ?></a><br /><br />&nbsp;<span class="loglink"><a href="<?php echo wp_logout_url( bp_get_root_domain() ) ?>"><?php _e( 'Log Out', TEMPLATE_DOMAIN ) ?></a></span>
