...
<?php wp_custom_post_thumbnail($the_post_ids, 'no', '100%', 'auto', get_the_title(), 'large', '650', '1999', 'alignleft'); ?>
...
<?php else: ?>
<?php custom_get_post_img ($the_post_ids, 'medium', $the_post_title, $height='70'); ?>
<?php endif; ?>
<?php endif; ?>

<?php } else { ?>
<?php wp_custom_post_thumbnail($the_post_ids, 'yes', '100%', '70px', get_the_title(), 'medium', '200', '699', 'alignleft feat-thumb'); ?>
<?php } ?>
