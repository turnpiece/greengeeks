...
#buddypress #post-navigator a, #setupform {
    background: <?php echo $tn_buddyfun_content_line_bg_color; ?> !important;
}
...
#buddypress ul#activity-filter-links li a,#buddypress ul#activity-filter-links li a:hover, #buddypress ul#activity-filter-links li.selected a  {
      color: <?php echo $tn_buddyfun_topnav_block_link_color; ?>!important;
	background: <?php echo $tn_buddyfun_topnav_block_color; ?>!important;
  }
<?php } ?>
...
#post-entry, #container .content #buddypress, div#subnav.item-list-tabs, #container table tbody tr {
background: <?php echo $tn_buddyfun_content_bg_color; ?>!important;
}
...
<?php } else { ?>
#container #buddypress #right-box #optionsbar #options-nav li.current a {
color: <?php echo $tn_buddyfun_body_text_color; ?>!important;
}
<?php } ?>
...
<?php } else { ?>
.info-bar a, #container #buddypress .info-group a, #container #buddypress .info-group a  {
