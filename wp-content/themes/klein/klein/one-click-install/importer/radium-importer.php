 ...
 if ( !class_exists( 'Radium_Theme_Importer' ) ) {
	...
	class Radium_Theme_Importer {
    	...
    	public function intro_html() {
			...
			<div style="background-color: #ECF0F1; margin:10px 0;padding: 20px 35px;color: #34495E;border: 1px solid #9B59B6; clear:both; width:90%; line-height:18px;">
			    ...
			    allow you to quickly edit everything instead of creating content from scratch. When you import the data following things will happen:</p>
			      ...
			      <ul style="padding-left: 20px;list-style-position: inside;list-style-type: square; margin-bottom: 35px;}">
			 ...
			 <div style="background-color: #ECF0F1; margin:10px 0;padding: 20px 35px;color: #34495E;border: 1px solid #9B59B6; clear:both; width:90%; line-height:18px;"><p class="tie_message_hint">Before you begin, make sure all the required plugins are activated.</p></div>

			 <?php

			 if( !empty($this->imported_demos) ) { ?>

			  	<div style="background-color: #FAFFFB; margin:10px 0;padding: 20px 35px;color: #8AB38A;border: 1px solid #a1d3a2; clear:both; width:90%; line-height:18px;">
