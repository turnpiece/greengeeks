		...
		<ul id="admins-list" class="item-list single-line">
			...
			<li>
				<div class="row mg-bottom-10">
					<div class="col-sm-2">
						<?php echo bp_core_fetch_avatar( array( 'item_id' => bp_get_member_user_id(), 'type' => 'thumb', 'width' => 72, 'height' => 72, 'alt' => sprintf( __( 'Profile picture of %s', 'buddypress' ), bp_get_member_name() ) ) ); ?>
					</div>
					<div class="col-sm-9">
						<h5>
					...
					<li>
						<div class="row">
							...
							<div class="col-sm-9">
								...
								<span class="small">
									<a href="<?php bp_group_member_promote_admin_link( array( 'user_id' => bp_get_member_user_id() ) ); ?>" class="fg-asbestos button confirm mod-promote-to-admin" title="<?php esc_attr_e( 'Promote to Admin', 'buddypress' ); ?>"><?php _e( 'Promote to Admin', 'buddypress' ); ?></a>
									 / <a class="fg-asbestos button confirm mod-demote-to-member" href="<?php bp_group_member_demote_link( bp_get_member_user_id() ); ?>"><?php _e( 'Demote to Member', 'buddypress' ); ?></a>
								</span>
							</div>
						</div>
					</li>
							...
							<div class="col-sm-9">
								...
								<?php if ( bp_get_group_member_is_banned() ) _e( '(banned)', 'buddypress' ); ?>
									...
									<?php if ( bp_get_group_member_is_banned() ) : ?>
										<a href="<?php bp_group_member_unban_link(); ?>" class="fg-asbestos button confirm member-unban" title="<?php esc_attr_e( 'Unban this member', 'buddypress' ); ?>"><?php _e( 'Remove Ban', 'buddypress' ); ?></a>
									<?php else : ?>
										<a href="<?php bp_group_member_ban_link(); ?>" class="fg-asbestos button confirm member-ban" title="<?php esc_attr_e( 'Kick and ban this member', 'buddypress' ); ?>"><?php _e( 'Kick &amp; Ban', 'buddypress' ); ?></a>
										/ <a href="<?php bp_group_member_promote_mod_link(); ?>" class="fg-asbestos button confirm member-promote-to-mod" title="<?php esc_attr_e( 'Promote to Mod', 'buddypress' ); ?>"><?php _e( 'Promote to Mod', 'buddypress' ); ?></a>
										/ <a href="<?php bp_group_member_promote_admin_link(); ?>" class="fg-asbestos button confirm member-promote-to-admin" title="<?php esc_attr_e( 'Promote to Admin', 'buddypress' ); ?>"><?php _e( 'Promote to Admin', 'buddypress' ); ?></a>
									<?php endif; ?>
										/ <a href="<?php bp_group_member_remove_link(); ?>" class="fg-asbestos button confirm" title="<?php esc_attr_e( 'Remove this member', 'buddypress' ); ?>"><?php _e( 'Remove from group', 'buddypress' ); ?></a>
