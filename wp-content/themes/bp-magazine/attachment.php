			...
			<h4><?php _e( 'Blog', 'bp_magazine' ) ?></h4>
				...
				<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
					...
					<div class="post" id="post-<?php the_ID(); ?>">
						...
						<h4><a href="<?php echo wp_get_permalink($post->post_parent); ?>" rev="attachment"><?php echo get_the_title($post->post_parent); ?></a> &raquo; <a href="<?php echo get_permalink() ?>" rel="bookmark" title="<?php _e( 'Permanent Link to', 'bp_magazine' ) ?> <?php the_title(); ?>"><?php the_title(); ?></a></h4>
				...
				<?php endwhile; else: ?>
					...
					<p><?php _e( 'Sorry, no attachments matched your criteria.', 'bp_magazine' ) ?></p>
