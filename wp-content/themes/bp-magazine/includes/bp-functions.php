...
function bp_dtheme_enqueue_scripts() {
	...
	$params = array(
		'my_favs'           => __( 'My Favorites', 'bp_magazine' ),
		'accepted'          => __( 'Accepted', 'bp_magazine' ),
		'rejected'          => __( 'Rejected', 'bp_magazine' ),
		'show_all_comments' => __( 'Show all comments for this thread', 'bp_magazine' ),
		'show_all'          => __( 'Show all', 'bp_magazine' ),
		'comments'          => __( 'comments', 'bp_magazine' ),
		'close'             => __( 'Close', 'bp_magazine' ),
		'view'              => __( 'View', 'bp_magazine' )
	);
...
function bp_dtheme_show_notice() {
	...
	<div id="message" class="updated fade">
		<p><?php printf( __( 'Theme activated! This theme contains <a href="%s">custom header image</a> support and <a href="%s">sidebar widgets</a>.', 'bp_magazine' ), admin_url( 'themes.php?page=custom-header' ), admin_url( 'widgets.php' ) ) ?></p>
	</div>
