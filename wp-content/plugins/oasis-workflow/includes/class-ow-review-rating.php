...
class OW_Review_Rating {
   ...
   public function set_rating_interval() {
      // check nonce
      check_ajax_referer( 'owf_rating_ajax_nonce', 'security' );
      $time_interval = date( 'Y-m-d', strtotime( '+48 hours' ) );
   ...
   public function show_review_rating() {
      ...
      $review_text .= '<span>Thank you for using <b>Oasis Workflow</b>. ';
      $review_text .= 'We hope Oasis Workflow has helped you to streamline your editorial review process. ';
      $review_text .= 'We welcome you to post a plugin review on WordPress, so that others can benefit from your experience. ';
      $review_text .= 'It also helps us to spread the word and boost our motivation.</span>';
      $review_text .= '<ul class="review-rating-list">';
      $review_text .= '<li><a href="https://login.wordpress.org/?redirect_to=https%3A%2F%2Fwordpress.org%2Fsupport%2Fview%2Fplugin-reviews%2Foasis-workflow" target="_blank" title="Ok, you deserved it">Ok, you deserve it.</a></li>';
      $review_text .= '<li><a href="javascript:void(0);" class="set-rating-interval" title="Nope, may be later">Nope, may be later.</a></li>';
      $review_text .= '<li><a href="javascript:void(0);" class="hide-rating" title="I already did">I already did.</a></li>';
      $review_text .= '</ul>';
