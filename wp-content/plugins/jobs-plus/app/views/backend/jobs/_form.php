        ...
        <div class="panel-body">
            <div
                ...
                <div class="col-sm-8">
                    ...
                    <?php else: ?>
                        ...
                        <span class="help-block m-b-none error-job_title"><?php $form->error("min_budget") ?></span>
                        <?php $form->text('max_budget', array(
                            'attributes' => array('class' => 'form-control')
                        )) ?>
                        <span class="help-block m-b-none error-job_title"><?php $form->error("max_budget") ?></span>
                    <?php endif; ?>
                </div>
                <div class="clearfix"></div>
            </div>
            <div class="form-group <?php echo $model->has_error("contact_email") ? "has-error" : null ?>">
                ...
                <div class="col-sm-8">
                    ...
                    <span class="help-block m-b-none error-job_title"><?php $form->error("contact_email") ?></span>
                </div>
                <div class="clearfix"></div>
            </div>
