<div class="ig-container">
    <div class="jobs-contact">
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?php echo get_post_type_archive_link(get_post_type()) ?>"><?php _e("Jobs", je()->domain) ?></a>
            </li>
            <li>
        ...
        <?php else: ?>
            ...
            <div class="form-group <?php echo $model->has_error("name") ? "has-error" : null ?>">
                <?php $form->label("name", array("text" => __("Your Name:", je()->domain), "attributes" => array("class" => "col-lg-3 control-label"))) ?>
                <div class="col-lg-9">
            ...
            <div class="form-group <?php echo $model->has_error("email") ? "has-error" : null ?>">
                <?php $form->label("email", array("text" => __("Contact email:", je()->domain), "attributes" => array("class" => "col-lg-3 control-label"))) ?>
                <div class="col-lg-9">
            ...
            <div class="form-group <?php echo $model->has_error("content") ? "has-error" : null ?>">
                <?php $form->label("content", array("text" => __("Content", je()->domain), "attributes" => array("class" => "col-lg-3 control-label"))) ?>
                <div class="col-lg-9">
                    <?php $form->text_area("content", array("attributes" => array("class" => "form-control", "style" => "height:150px"))) ?>
