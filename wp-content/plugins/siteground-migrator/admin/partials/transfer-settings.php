	...
	<div class="flex flex--gutter-xx-large flex--margin-medium">
		...
		<div class="settings">
			<p class="text text--size-medium typography typography--weight-regular with-color with-color--color-darkest">
				<?php echo __( 'This plugin is designed to automate the transfer of your WordPress to your account at SiteGround hosting. To initiate the transfer you will need to provide your transfer token. It can be generated through your <strong>SiteGround cPanel <span class="dashicons dashicons-arrow-right"></span> WordPress tools <span class="dashicons dashicons-arrow-right"></span> WordPress Migrator</strong>. You can check out this tutorial if you need more detailed instructions.', 'siteground-migrator' ); ?>
			</p>
				...
				<label class="checkbox checkbox--medium checkbox--align-center field-label">
					...
					<span id="checkbox__label_email">
						...
						<span class="field-wrapper field-wrapper--small">
							<input type="email" class="field" name="siteground_migrator_email_recipient" required pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" value="<?php echo get_option( 'admin_email' ) ?>"/>
							<span class="validation validation--error validation--required">
								<?php esc_html_e( 'This field is required', 'siteground-migrator' ); ?>
							</span>
