...
In the backend control panel you can specify the following:
...
Simply use the shortcodes [fep_submission_form] and [fep_article_list] to get started (But DO NOT add the two codes on the same post or page)
